        ...
        <table class="table table-items">
            <thead>
                <tr>
                    ...
                    @if($invoice->hasItemUnits)
                        <th scope="col" class="text-center border-0">{{ __('invoices::invoice.status') }}</th>
                    @endif
                    <th scope="col" class="text-center border-0">{{ 'Payment Status' }}</th>
                    <th scope="col" class="text-right border-0">{{ __('Amount') }}</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    @if($invoice->hasItemUnits)
                        <td class="text-center">{{ $invoice->buyer->status }}</td>
                    @endif
                    <td class="text-center">{{ $invoice->seller->status }}</td>
                    <td class="text-right">
