        ...
        <div class="row mt-4">
                ...
                <div class="mt-4">
                    ...
                    <div class="text-95 text-secondary-d3">
                        <div class="row mb-2 mb-sm-0 py-25">
                            ...
                            <div class="col-2 text-secondary-d2">{{$phone}}</div>
            ...
            -->
                    ...
                    <div>
                        ...
                        <button type="submit" class="btn bg-gradient-success btn-lg">Continue</button>
                        @else
                        <button type="submit" class="btn bg-gradient-success btn-lg">Pay Now</button>
                        @endif
