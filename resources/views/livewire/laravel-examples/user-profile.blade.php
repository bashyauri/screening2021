...
<div>
    ...
    <div class="container-fluid py-4">
        <div class="card">
            ...
            <div class="card-body pt-4 p-3">
                      ...
                      <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            <form>
                              <div class="form-group">
                                <label for="institutionName" class="col-form-label">Name Of Institution:</label>
                          ...
                          <div class="modal-footer">
                            ...
                            <button wire:click = "addInstitution" type="button" class="btn bg-gradient-primary">Send message</button>
                          </div>
                        </div>
                      </div>
                    </div>
                 ...
                 <div class="col-md-4 col-sm-6">
                    <div class="form-group ">
                        ...
                        <select wire:model="name" class="form-control form-select"  >
                            ...
                            <option value="1">Higher National Diploma</option>
                            <option value="2">National Diploma</option>
                            <option value="3">Diploma Special</option>
                        </select>
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="form-group">
                        ...
                        <select  class="form-control form-select" list="gender"  >
                            <option>Select</option>
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="form-group">
                        ...
                        <input type="date"  class="form-control" id="teamPrice" />
                        @error('price') <span class="error">{{ $message }}</span> @enderror
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4 col-sm-6">
                <div class="form-group">
                    ...
                    <input type="text" wire:model="date" class="form-control" id="teamPrice" />
                    @error('price') <span class="error">{{ $message }}</span> @enderror
                </div>
            </div>
        ...
        <div class="row">     
            ...
            <div class="form-group">
                <label for="title">States:</label>
                <select name = "selectedState" wire:model="selectedState" class="form-control">
        ...
        <div class="col-md-4 col-sm-4">
            <div class="form-group">
                ...
                @error('price') <span class="error">{{ $message }}</span> @enderror
                        ...
                        <button class="btn btn-lg bg-gradient-dark btn-md mt-4 mb-4" wire:click="firstStepSubmit"
                ...
                <div class="row setup-content {{ $currentStep != 3 ? 'display-none' : '' }}" id="step-3">
                    ...
                    <div class="d-flex d-flex justify-content-between">
                        <button class="btn bg-gradient-dark btn-md mt-4 mb-4" type="button" wire:click="back(2)">{{ 'Back' }}</button>
                        <button click="$set('selectedState', 2)"type="submit"  class="btn bg-gradient-dark btn-md mt-4 mb-4">{{ 'Save Changes' }}</button>
