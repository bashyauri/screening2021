                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6">
                        <div class="form-group">
                            ...
                            <select wire:model="subjectName" class="form-control">
                                ...
                                <option value="Walls, Floors and Cetling Finishing"> Walls, Floors and Cetling Finishing
                                </option>
                                <option value="Animal Husbandry"> Animal Husbandry</option>
                                @error('subjectName') <div class="text-danger">{{ $message }}</div> @enderror
                            </select>
                    ...
                    <div class="col-lg-4">
                        <div class="form-group">
                            ...
                            <label for="subjectGrade" class="col-form-label">Subject Grade:</label>
                            <select wire:model="subjectGrade" class="form-control">
                            ...
                            @error('subjectGrade') <div class="text-danger">{{ $message }}</div> @enderror
                        ...
                        <div class="form-group">
                            ...
                            <select wire:model="exam" class="form-control">
                                ...
                                @foreach ($examDetails as $exam)
                                    ...
                                    @error('exam') <div class="text-danger">{{ $message }}</div> @enderror
                                @endforeach
                            </select>
                        </div>
