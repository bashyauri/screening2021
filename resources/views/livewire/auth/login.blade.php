                ...
                <div class="col-xl-4 col-lg-5 col-md-6 d-flex flex-column mx-auto">
                    <div class="card card-plain mt-8">
                        ...
                        <div class="card-header pb-0 text-left bg-transparent">
                            <img src="../assets/img/logos/poly_logo.png">
                            ...
                            <p class="mb-0">{{ __('Phone: ') }}<b>{{ __('your registered phone number') }}</b></p>
                            <p class="mb-0">{{ __('Password: ') }}<b>{{ __('secret password') }}</b></p>
                        </div>
                        <div class="card-body">
                            <form wire:submit.prevent="login" action="#" method="POST" role="form text-left">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="@error('phone')border border-danger rounded-3 @enderror">
                                        <input wire:model="phone" id="phone" type="tel" class="form-control"
                                            placeholder="Phone no:" aria-label="Phone" aria-describedby="phone-addon">
                                    </div>
                ...
                <div class="col-md-6">
                    <div class="oblique position-absolute top-0 h-100 d-md-block d-none me-n8">
                        <div class="oblique-image bg-cover position-absolute fixed-top ms-auto h-100 z-index-0 ms-n6"
                            style="background-image:url('../assets/img/curved-images/curved6.jpeg')"></div>
                    </div>
                </div>
            </div>
        </div>
