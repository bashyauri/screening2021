                ...
                <div class="col-xl-4 col-lg-5 col-md-6 d-flex flex-column mx-auto">
                    <div class="card card-plain mt-8">
                        <div class="card-header pb-0 text-left bg-transparent">
                            ...
                            @endif
                            <h4 class="mb-0">{{ __('Forgot your password? Enter your phone here') }}</h4>
                        </div>
                        <div class="card-body">
                                ...
                                <div>
                                    ...
                                    <div class="@error('phone')border border-danger rounded-3 @enderror">
                                        <input wire:model="phone" id="phone" type="text" class="form-control"
                                            placeholder="Registered phone number" aria-label="Phone" aria-describedby="phone-addon">
                                    </div>
                                    @error('phone') <div class="text-danger">{{ $message }}</div> @enderror
                                </div>
                                <div class="text-center">
                                    <button  wire:click="showPassword"  type="submit"
