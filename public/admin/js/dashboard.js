(function ($) {
    ...
    $(function () {
        ...
        function format(d) {
            ...
            if (d.exam_grades && d.exam_grades.length > 0) {
                examGradesHTML +=
                    '<table cellpadding="5" cellspacing="0" border="0" style="width:100%;">';
                examGradesHTML += '<tr class="expanded-row">';
                examGradesHTML +=
                ...
                // Loop through each exam grade row
                d.exam_grades.forEach((grade) => {
                    examGradesHTML +=
                        "<h6>" +
                        grade.subject_name +
                        "-" +
                ...
                examGradesHTML +=
                    ...
                    '<input type="checkbox" name="recommend" id="recommend-checkbox" value=' +
                    d.account_id +
                    ">" +
                    "Recommend" +
                    "</label>" +
                ...
                examGradesHTML += "</tr>";
                examGradesHTML += "</table>";
            }

            return examGradesHTML;
        }
